export default {
  pl: {
    ...
    all: 'Wszystkie',
    alreadyVerified: 'Zweryfikowano',
    atLeast4Characters: 'Wpisz co najmniej 4 znaki',
    authorOfChange: 'Autor',
    available: 'jest',
    ...
    mustBeOnline: 'Musisz być online, aby wykonać tę akcję',
    ...
    reset: 'Wyczyść',
    revertThisChange: 'Cofnij zmianę',
    save: 'Zapisz',
  ...
  en: {
    ...
    mustBeOnline: 'You must be online to perform this action',
    ...
    reset: 'Clear',
    revertThisChange: 'Revert change',
    save: 'Save',
