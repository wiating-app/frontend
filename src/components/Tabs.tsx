  ...
  return (
    <button
      ...
      className={classNames(
        'relative px-3 sm:px-6 py-3 text-sm',
...
const Tabs = ({ value, onChange, children, className }: TabsProps) => {
  return (
    <div className={classNames('border-solid border-b-2 border-t-0 border-l-0 border-r-0 border-gray-200', className)}>
      <nav className="flex gap-1 overflow-x-auto overflow-y-hidden flex-nowrap scroll-smooth -mx-1 px-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
