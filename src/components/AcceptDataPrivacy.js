...
const AcceptDataPrivacy = () => {
  ...
  return isVisible
    ? <Modal onClose={acceptDataPrivacy} short>
      ...
      <p>Administratorem danych osobowych jest Administracja Grupy Wiating - Dariusz Hajduk, adres e-mail: wiating@wiating.eu</p>
      ...
      <p>Więcej informacji w <span onClick={() => { acceptDataPrivacy(); history.push('/polityka-prywatnosci') }}>polityce prywatności</span>.</p>
